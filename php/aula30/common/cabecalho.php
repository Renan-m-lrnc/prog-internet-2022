<?php
  session_start(); //Iniciando controle de sessão de usuário
      ...
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <div class="text-end">
          ...
          if(isset($_SESSION["logado"]) && $_SESSION["logado"]){
            ?>
          <button type="button" class="btn btn-outline-light me-2" onclick="location.href='<?=URL_BASE?>logoff.php'" >Logoff</button>
            <?php
              } else {
            ?>
